...
@interface MusicPlayerListManage ()<AVPlayerManageDelegate>
...
@implementation MusicPlayerListManage

+(MusicPlayerListManage *)shareMusicPlayerListManage{
    
    static MusicPlayerListManage *manage = nil;
