...
@property (nonatomic,strong) MusicPlayerListManage *musicPLManage;// 音乐播放列表
...
-(void)likeButtonAction:(UIButton*)sender{
    ...
    CollectListManage  *collect = [CollectListManage shareMusicPlayerListManage];
...
-(void)listButtonAction:(UIButton *)sender
{
    ...
    self.MPLVC.disappearBlack = ^(){
        ...
        _cycletype = [defaults integerForKey:@"cycleType"];
...
-(AVPlayerManage *)avPlayer{
    
    if (_avPlayer == nil) {
        
        _avPlayer = [AVPlayerManage shareAVPlayerManage];
