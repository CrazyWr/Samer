...
@property (nonatomic,strong) CollectListManage *collectManage;//收藏列表
...
-(CollectListManage *)collectManage
{
    if (_collectManage == nil) {
        
        _collectManage = [CollectListManage shareMusicPlayerListManage];
