...
@interface CollectListManage ()<AVPlayerManageDelegate>
...
@implementation CollectListManage

+(CollectListManage *)shareMusicPlayerListManage{
    
    static CollectListManage *manage = nil;
    
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken, ^{
        
        manage=  [[CollectListManage alloc]init];
