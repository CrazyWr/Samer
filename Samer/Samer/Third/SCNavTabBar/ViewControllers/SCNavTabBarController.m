...
- (void)viewInit
{
    ...
    // 顶部横条滚动视图设置
    _navTabBar = [[SCNavTabBar alloc] initWithFrame:CGRectMake(DOT_COORDINATE, DOT_COORDINATE+20, SCREEN_WIDTH, NAV_TAB_BAR_HEIGHT-25) showArrowButton:_showArrowButton];
    //20 -15
    ...
    // 里面内容视图设置
    _mainView = [[UIScrollView alloc] initWithFrame:CGRectMake(DOT_COORDINATE,_navTabBar.frame.origin.y + _navTabBar.frame.size.height-18, SCREEN_WIDTH, SCREEN_HEIGHT - _navTabBar.frame.origin.y - _navTabBar.frame.size.height - STATUS_BAR_HEIGHT - NAVIGATION_BAR_HEIGHT + 20)];
